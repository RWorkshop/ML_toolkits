---
title: "``MachineShop::GAMBoostModel ``"
...
Gradient boosting for optimizing arbitrary loss functions, where component-wise arbitrary baselearners,
e.g., smoothing procedures, are utilized as additive base-learners.
